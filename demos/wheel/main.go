...
var rateList []Prate = []Prate{
	Prate{"一等奖，1000亿津巴布韦元", 1, 0, 9999, temp},
	Prate{"二等奖，10元优惠券", 2, 1, 2, 2},
	Prate{"三等奖，5积分", 10, 3, 5, 10},
	Prate{"",0, 0, 9999, 0},
}
...
func (c *lotteryController) Get() string {
	...
	// return fmt.Sprintf("大转盘奖品列表：<br/> %s", strings.Join(string(rateList）, "<br/>\n"))
	return ""
}
